...
import Logo from "/public/XyclooLabsLogo.jpeg";
  ...
  return (
    <Navbar fluid className="py-3 ">
      ...
      <Navbar.Collapse>
        ...
        <Navbar.Link href="/pools" className="md:hover:text-[#14b780]">Insurances</Navbar.Link>
        <Navbar.Link href="/ecosystem" className="md:hover:text-[#14b780]">Liquidity</Navbar.Link>
